...
void PatternSolver::Initialize()
{
    ...
    ms_patterns[PATID_SetCharacterDefinitions] = GetPattern("48 85 D2 0F 84 ? ? ? ? 48 89 5C 24 ? 48 89 6C 24 ? 56 48 83 EC 30 41 0F B6 D8 48 8B F2 48 8B E9 84 DB 75 07 0F B6 41 2C 88 42 51 48 89 7C 24", 0);
